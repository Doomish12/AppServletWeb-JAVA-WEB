     ...
     <img class="num2" src="img/Register.gif" width="400px" height="400px">
        ...
        <form action="LoginServlet" method="post" name="registrarse" id="registro-exito">
          <h2 class="num1">Registrate</h2>
            ...
            <div class="mb-3">
                <label for="password" class="form-label num7">Contraseña:</label>
            ...
            <div class="form-check mb-3">
                ...
                <label class="form-check-label num8" for="terms " style=" display:block;">He leído y acepto los Términos y condiciones y las Políticas de privacidad.</label>
            </div>
...
<script>
  document.getElementById('registro-exito').addEventListener('submit', function(event) {
    ...
    if (nombre === '' || apellido === '' || email === '' || username === '' || password === '' || !terms) {
      // Mostrar un mensaje de error si algún campo está vacío o los términos no están aceptados
      Swal.fire({
        icon: 'error',
        title: 'Error',
      ...
      // Mostrar la alerta de éxito si todos los campos están completos y los términos están aceptados
      Swal.fire({
        icon: 'success',
